  ...
  return (
    <>
      <style>{`
        ...
        .jc-company { color: #6b7280; font-size: 13px; margin: 0 0 6px; display: flex; align-items: center; gap: 5px; font-weight: 500; }
        .jc-location { color: #9ca3af; font-size: 12px; margin: 0 0 14px; }
        .jc-desc {
          font-size: 12.5px; color: #6b7280; line-height: 1.6; margin: 0 0 14px;
          overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical;
        }
        .jc-actions { display: flex; gap: 8px; flex-wrap: wrap; }
        .jc-view-btn {
          background: #f1f5f9; color: #374151; border: none; padding: 9px 16px;
          border-radius: 10px; font-size: 12.5px; font-weight: 700; cursor: pointer;
          font-family: inherit;
        }
        .jc-wa-btn {
          background: linear-gradient(135deg, #22c55e, #16a34a); color: white;
          border: none; padding: 9px 18px; border-radius: 10px; font-size: 12.5px;
          font-weight: 700; cursor: pointer; display: inline-flex; align-items: center; gap: 7px;
          font-family: inherit; box-shadow: 0 3px 10px rgba(34,197,94,0.28); transition: all 0.2s ease;
        }
        .jc-wa-btn:hover { transform: translateY(-1px); }
      ...
      <div className="jc-card" onClick={goToDetail}>
        ...
        <div className="jc-info">
          ...
          {job.company && <p className="jc-company">🏢 {job.company}</p>}
          ...
          <div className="jc-actions">
            <button className="jc-view-btn" onClick={function(e) { e.stopPropagation(); goToDetail() }}>
              View Details →
            </button>
