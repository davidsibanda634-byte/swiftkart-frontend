    ...
    >
      ...
      <div onClick={() => navigate(`/listings/${listing._id}`)}>
        ...
        <div style={{ padding: '10px 12px 4px' }}>
          ...
          <p style={{ color: '#1a56db', fontWeight: '700', fontSize: '14px', marginBottom: '2px' }}>
            ${listing.price}
          </p>
      ...
      {/* Seller Name — clickable to profile */}
      {listing.user && (
        <div onClick={() => navigate(`/profile/${listing.user._id}`)}
          style={{ padding: '4px 12px 8px', display: 'flex', alignItems: 'center', gap: '6px', cursor: 'pointer' }}
        >
          <div style={{
      ...
      <div style={{ padding: '0 12px 12px', display: 'flex', justifyContent: 'center' }}>
        <a href={whatsappLink} target="_blank" rel="noopener noreferrer" style={{ width: '100%' }}>
          <button style={{
