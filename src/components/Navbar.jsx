  ...
  return (
    <>
      <style>{`
        ...
        .sk-btn-login:hover { background: rgba(255,255,255,0.1); border-color: white; }
        ...
        .sk-btn-register:hover { transform: translateY(-1px); }
        ...
        .sk-btn-logout:hover { background: rgba(255,255,255,0.15); }
      ...
      <nav className="sk-navbar">
          ...
          <div className="sk-nav-right">
            ...
            {user ? (
              <>
                ...
                <Link to="/my-listings" className="sk-btn-login">My Listings</Link>
                <button onClick={handleLogout} className="sk-btn-logout">Logout</button>
              </>
            ) : (
              <>
                <Link to="/login" className="sk-btn-login">Login</Link>
                <Link to="/register" className="sk-btn-register">Register</Link>
              </>
            )}
          </div>
        ...
        {menuOpen && (
          <div className="sk-mobile-menu">
            ...
            {user ? (
              <>
                <span className="sk-mobile-nav-link" style={{ color: 'rgba(255,255,255,0.5)', cursor: 'default' }}>
                  Hi, {user.name}
                </span>
                <Link to="/my-listings" onClick={() => setMenuOpen(false)}
                  className="sk-mobile-action"
                  style={{ background: 'rgba(255,255,255,0.1)', color: 'white', marginBottom: 6 }}>
                  My Listings
                </Link>
                <Link to="/create" onClick={() => setMenuOpen(false)}
                  className="sk-mobile-action"
                  style={{ background: 'linear-gradient(135deg,#10b981,#059669)', color: 'white', marginBottom: 6 }}>
                  + Post Listing
                </Link>
