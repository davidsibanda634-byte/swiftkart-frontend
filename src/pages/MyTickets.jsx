                ...
                <Link to={`/tickets/${ticket._id}`} key={ticket._id} style={s.ticketCard}>
                  <div style={s.cardLeft}>
                    ...
                    <div style={s.cardMeta}>
                      ...
                      {ticket.event?.location?.area ? ", " + ticket.event.location.area : ""}
...
const s = {
  ...
  ticketCard: {
    ...
    background: "#fff", borderRadius: 12, padding: "16px", textDecoration: "none",
    boxShadow: "0 1px 6px rgba(0,0,0,0.06)", border: "1px solid #f0f0f0"
  },
  cardLeft:   { flex: 1, minWidth: 0 },
  cardEvent:  {
    fontSize: 15, fontWeight: 600, color: "#1a1a2e", marginBottom: 4,
  ...
  browseBtn:  {
    ...
    background: "#00b09b", color: "#fff", borderRadius: 8,
